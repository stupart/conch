...
// Sending stops the reading, speech never starts over an open mic, manual
// holds what conch volunteers, and what a person asked for still plays: all
// executed against the voice loop in voice-loop.test.ts since cut four.
